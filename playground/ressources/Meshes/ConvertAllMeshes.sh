...
# quick & dirty path
TOOL_PATH="/home/maurotux/Coding/OpenGL/SCEngine/SCE_Tools/AssetProccessor"
# PWD=$(eval pwd)
...
COMMAND_ARGS="$PWD/CobbleStones2.obj 1.0 0 0, $PWD/house_obj.obj 0.015 0 0, $PWD/SCORPION.OBJ 30.0 0 0, $PWD/T_REX.OBJ 1.0 0 0, $PWD/RB-SideSwipe.obj 0.025 0 0, $PWD/GringottsDragon.obj 30.0 0 0, $PWD/Goku.obj 0.105 0 0, $PWD/Eurofighter.obj 1.0 0 0, $PWD/Wolf.obj 0.5 0 0, $PWD/EAGLE_3.OBJ 3.0 0 0, $PWD/EAGLE_2.OBJ 3.0 0 0"
# for file in $FILES
# do
